...
<head>
    ...
    <link rel="stylesheet" href="Stly1\boptions.css">
</head>
<body>
    <div class="main">
        <div class="navbar">
    ...
    <div class="border1" style="border-style: groove; border-color: black"></div>
        ...
        <div class="border2" style="border-style: groove; border-color: black"></div>
            ...
            <h2 class="htxt">Banking Options</h2><br />
            <div class="tm">
                <ul>
                    <li>
                        <a href="home2.php" target="_blank">
                            <h4 class="txtim">Dashboard</h4><br />
                            <img src="img12/dashboard.png" alt="dashboard" width="150px" height="150px" />
                        </a>
                    </li>
                    <li>
                        <a href="loan.php" target="_blank">
                            <h4 class="txtim">Loans</h4><br />
                            <img src="img12/loans.png" alt="Loans" width="150px" height="150px" />
                        </a>
                    </li>
                    <br>
                    <br>
                    <li>
                        <a href="Deposits.php" target="_blank">
                            <h4 class="txtim">Deposits</h4><br />
                            <img src="img12/deposits.png" alt="Deposits" width="150px" height="150px" />
                        </a>
                    </li>
                    <li>
                        <a href="#" target="_blank">
                            <h4 class="txtim">Credit Cards</h4><br />
                            <img src="img12/cards.png" alt="Credit Cards" width="150px" height="150px" />
                        </a>
                    </li>
                </ul>
            </div>
