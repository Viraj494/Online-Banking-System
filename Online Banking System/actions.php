...
<head>
    ...
    <link rel="stylesheet" href="Stly1\actions.css">
</head>
<body>
    <div class="main">
        <div class="navbar">
    ...
    <div class="border1" style="border-style: groove; border-color: black"></div>
        <div class="sidebar">
            ...
            <a href="Deeposits.php">Deposits</a>
        ...
        <div class="border2" style="border-style: groove; border-color: black"></div>
            ...
            <h2 class="htxt">Actions</h2><br />
            <div class="tm">
                <ul>
                    <li>
                        <a href="transfermoney.php" target="_blank">
                            <h4 class="txtim">Transfer Money</h4><br />
                            <img src="img12/exchange.png" alt="Transfer Money" width="150px" height="150px" />
                        </a>
                    </li>
                    <li>
                        <a href="#" target="_blank">
                            <h4 class="txtim">Quick Pay</h4><br />
                            <img src="img12/wallet.png" alt="Quick Pay" width="150px" height="150px" />
                        </a>
                    </li>
                    <li>
                        <a href="#" target="_blank">
                            <h4 class="txtim">Open an Account</h4><br />
                            <img src="img12/kyc.png" alt="Open an Account" width="150px" height="150px" />
                        </a>
                    </li>
                </ul>
            </div>
